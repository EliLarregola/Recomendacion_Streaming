...
def cantidad_filmaciones_dia(dia: str):
    ...
    return f"{count} películas fueron estrenadas en el día {dia}"
...
def score_titulo(titulo: str):
    ...
    año = int(film_info['release_year'])  # Convertir a tipo de dato nativo de Python
    score = float(film_info['vote_average'])  # Convertir a tipo de dato nativo de Python
...
def get_actor(nombre_actor: str):
    ...
    return f"El actor {nombre_actor} ha participado de {count_films} filmaciones, el mismo ha conseguido un retorno de {total_ret} con un promedio de {avg_ret} por filmación"
